package hqsc.ray.uaa.translator;
 ...
 */
@Slf4j
@Component("rayWebRespExceptionTranslator")
public class RayWebRespExceptionTranslator implements WebResponseExceptionTranslator {
