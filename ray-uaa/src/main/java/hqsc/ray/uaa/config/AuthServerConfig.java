...
import hqsc.ray.uaa.granter.CaptchaTokenGranter;
import hqsc.ray.uaa.granter.UserTokenGranter;
import hqsc.ray.uaa.service.impl.ClientDetailsServiceImpl;
...
import hqsc.ray.uaa.granter.SmsCodeTokenGranter;
import hqsc.ray.uaa.granter.SocialTokenGranter;
import hqsc.ray.uaa.translator.RayWebRespExceptionTranslator;
...
public class AuthServerConfig extends AuthorizationServerConfigurerAdapter {
    ...
    private final RayWebRespExceptionTranslator exceptionTranslator;
    ...
    private TokenGranter tokenGranter(final AuthorizationServerEndpointsConfigurer endpoints) {
        ...
        granters.add(new UserTokenGranter(authenticationManager, endpoints.getTokenServices(), endpoints.getClientDetailsService(),
                endpoints.getOAuth2RequestFactory(), redisService, factory));
    ...
    public TokenEnhancer tokenEnhancer() {
        return new TokenEnhancer() {
            ...
            public OAuth2AccessToken enhance(OAuth2AccessToken oAuth2AccessToken, OAuth2Authentication oAuth2Authentication) {
                ...
                // 获取当前登录的用户
                RayUser user = (RayUser) oAuth2Authentication.getUserAuthentication().getPrincipal();
                ...
                if (user != null) {
                    ...
                    additionMessage.put("userType",user.getUserType());
                }
