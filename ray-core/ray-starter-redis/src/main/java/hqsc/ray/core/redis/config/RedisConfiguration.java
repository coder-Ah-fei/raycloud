package hqsc.ray.core.redis.config;

import com.fasterxml.jackson.annotation.JsonAutoDetect;
import com.fasterxml.jackson.annotation.PropertyAccessor;
import com.fasterxml.jackson.databind.ObjectMapper;
import hqsc.ray.core.redis.core.RedisService;
import hqsc.ray.core.redis.props.RayRedisProperties;
 ...
 */
@Configuration
@EnableConfigurationProperties(RayRedisProperties.class)
@ConditionalOnProperty(value = RayRedisProperties.PREFIX + ".enabled", havingValue = "true", matchIfMissing = true)
