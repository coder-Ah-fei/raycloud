package hqsc.ray.core.log.aspect;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import hqsc.ray.core.common.dto.CommonLog;
import hqsc.ray.core.common.util.*;
...
import hqsc.ray.core.log.event.LogEvent;
...
public class LogAspect {
    ...
    @Pointcut("@annotation(hqsc.ray.core.log.annotation.Log)")
    ...
    public Object recordLog(ProceedingJoinPoint point) throws Throwable {
        ...
        .setTraceId(request.getHeader(RayConstant.RAY_TRACE_ID))
