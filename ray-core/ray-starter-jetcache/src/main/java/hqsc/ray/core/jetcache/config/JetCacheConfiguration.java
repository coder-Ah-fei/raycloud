package hqsc.ray.core.jetcache.config;
...
@Configuration
@EnableMethodCache(basePackages = "hqsc.ray.system")
@EnableCreateCacheAnnotation
@PropertySource(factory = YamlPropertySourceFactory.class, value = "classpath:ray-jetcache.yml")
