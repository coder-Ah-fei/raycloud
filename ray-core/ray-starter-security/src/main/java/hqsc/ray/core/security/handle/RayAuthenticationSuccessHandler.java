package hqsc.ray.core.security.handle;
 ...
 */
@Slf4j
public class RayAuthenticationSuccessHandler implements AuthenticationSuccessHandler {
	...
	public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication) throws IOException {
		...
		// 直接结束
		response.setContentType(RayConstant.JSON_UTF8);
