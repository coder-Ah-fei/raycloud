...
import hqsc.ray.core.feign.config.RayFeignAutoConfiguration;
 ...
 * @author L.cm
 */
public class RayFeignClientsRegistrar implements ImportBeanDefinitionRegistrar, BeanClassLoaderAware, EnvironmentAware {
    ...
    private Class<?> getSpringFactoriesLoaderFactoryClass() {
        return RayFeignAutoConfiguration.class;
    }
