...
import hqsc.ray.core.feign.fallback.RayFallbackFactory;

/**
 * 添加 ray 默认的 fallbackFactory L.cm 2019.01.19
 *
 * @author L.cm
 * @author Spencer Gibb
 * @author Erik Kringen
...
public class RayHystrixTargeter implements Targeter {
    @Override
    public <T> T target(FeignClientFactoryBean factory, Feign.Builder feign, FeignContext context,
        ...
        // ray 默认的 fallbackFactory
        RayFallbackFactory<T> rayFallbackFactory = new RayFallbackFactory<>(target);
        return builder.target(target, rayFallbackFactory);
    }
