...
@Slf4j
@AllArgsConstructor
public class RayFeignFallback<T> implements MethodInterceptor {
    ...
    public Object intercept(Object o, Method method, Object[] objects, MethodProxy methodProxy) throws Throwable {
        ...
        log.error("RayFeignFallback:[{}.{}] serviceId:[{}] message:[{}]", targetType.getName(), method.getName(), targetName, errorMessage);
    ...
    public boolean equals(Object o) {
        ...
        RayFeignFallback<?> that = (RayFeignFallback<?>) o;
