...
public class RequestLogFilter implements GlobalFilter, Ordered {
	...
	public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
		...
		String traceId = exchange.getRequest().getHeaders().getFirst(RayConstant.RAY_TRACE_ID);
		// 构建成一条长 日志，避免并发下日志错乱
		StringBuilder beforeReqLog = new StringBuilder(300);
		// 日志参数
		List<Object> beforeReqArgs = new ArrayList<>();
		beforeReqLog.append("\n\n================ Ray Gateway Request Start  ================\n");
		// 打印路由
		beforeReqLog.append("===> {}: {}\n");
		// 参数
		...
		beforeReqLog.append("================ Ray Gateway Request End =================\n");
		// 打印执行时间
		...
		return chain.filter(exchange).then(Mono.fromRunnable(() -> {
			...
			responseLog.append("\n\n================ Ray Gateway Response Start  ================\n");
			// 打印路由 200 get: /ray*/xxx/xxx
			responseLog.append("<=== {} {}: {}: {}\n");
			// 参数
			...
			responseLog.append("================  Ray Gateway Response End  =================\n");
			// 打印执行时间
