package hqsc.ray.system.aspect;
...
import hqsc.ray.core.common.exception.PreviewException;
import hqsc.ray.core.common.util.RequestHolder;
...
public class PreviewAspect {
    ...
    @Value("${ray.preview.enable}")
    private boolean isPreview = false;

    private final AntPathMatcher antPathMatcher = new AntPathMatcher();

    @Around(
            "execution(static hqsc.ray.core.common.api.Result *(..)) || " +
