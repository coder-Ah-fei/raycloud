...
import hqsc.ray.core.file.util.ExcelUtil;
import hqsc.ray.core.log.annotation.Log;
import hqsc.ray.core.web.annotation.EnableUser;
import hqsc.ray.core.web.controller.BaseController;
import hqsc.ray.core.web.tree.ForestNodeMerger;
import hqsc.ray.core.web.util.CollectionUtil;
import hqsc.ray.system.dto.SysMenuDTO;
...
public class SysMenuController extends BaseController {
    ...
    public Result<?> list(@ApiIgnore @RequestParam Map<String, Object> search) {
        return Result.data(TreeUtil.list2Tree(sysMenuService.searchList(search), RayConstant.TREE_ROOT));
    }
