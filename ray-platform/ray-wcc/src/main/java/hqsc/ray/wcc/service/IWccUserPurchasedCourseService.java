 ...
 * @since 2020-12-30
 */
public interface IWccUserPurchasedCourseService extends IService<WccUserPurchasedCourse> {
     ...
     * @return IPage
     */
	IPage<WccUserPurchasedCourse> listPage(Page page, Map<String, Object> search);
