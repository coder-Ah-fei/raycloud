 ...
 * @since 2020-12-30
 */
public interface IWccMerchantBrandDetailService extends IService<WccMerchantBrandDetail> {
     ...
     * @return IPage
     */
	IPage<WccMerchantBrandDetail> listPage(Page page, Map<String, Object> search);
