...
public class RedisUtil {
	...
	public synchronized static Object getObject(String key) {
		...
		try {
			...
			return SerializableUtil.unserizlize(bytes);
	 ...
	 * @return
	 */
	public synchronized static String setObject(String key, Object value) {
		Jedis jedis = null;
		try {
			jedis = getJedis();
	...
	public synchronized static String setObject(String key, Object value,int expiretime) {
		String result = "";
		Jedis jedis = null;
		try {
			jedis = jedisPool.getResource();
	 ...
	 * 删除key
	 */
	public synchronized static Long delkeyObject(String key) {
		Jedis jedis = null;
		try {
			jedis = jedisPool.getResource();
