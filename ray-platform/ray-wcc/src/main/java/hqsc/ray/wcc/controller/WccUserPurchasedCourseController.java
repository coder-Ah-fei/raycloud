...
@RestController
@AllArgsConstructor
@RequestMapping("/wcc-user-purchased-course")
@Api(value = "用户已购课程表", tags = "用户已购课程表接口")
public class WccUserPurchasedCourseController extends BaseController {

    private final IWccUserPurchasedCourseService wccUserPurchasedCourseService;
     ...
     */
    @PreAuth
    @Log(value = "用户已购课程表列表", exception = "用户已购课程表列表请求异常")
    @GetMapping("/page")
    @ApiOperation(value = "用户已购课程表列表", notes = "分页查询")
    @ApiImplicitParams({
    ...
    public Result<?> page(Page page, Map search) {
		return Result.data(wccUserPurchasedCourseService.listPage(page, search));
    }
    ...
    * 用户已购课程表设置
    *
    * @param wccUserPurchasedCourse WccUserPurchasedCourse 对象
    * @return Result
    */
    @PreAuth
    @Log(value = "用户已购课程表设置", exception = "用户已购课程表设置请求异常")
    @PostMapping("/set")
    @ApiOperation(value = "用户已购课程表设置", notes = "用户已购课程表设置,支持新增或修改")
    public Result<?> set(@Valid @RequestBody WccUserPurchasedCourse wccUserPurchasedCourse) {
