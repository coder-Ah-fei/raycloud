 ...
 * @since 2020-12-30
 */
public interface IWccBrandMerchantAuthService extends IService<WccBrandMerchantAuth> {
     ...
     * @return IPage
     */
	IPage<WccBrandMerchantAuth> listPage(Page page, Map<String, Object> search);
