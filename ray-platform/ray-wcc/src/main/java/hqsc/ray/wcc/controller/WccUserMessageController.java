...
public class WccUserMessageController extends BaseController {
    ...
    private final IWccUserMessageService wccUserMessageService;
    ...
    public Result<?> page(Page page, Map search) {
		return Result.data(wccUserMessageService.listPage(page, search));
    }
    ...
    public Result<?> get(@RequestParam String id) {
		return Result.data(wccUserMessageService.getById(id));
	}
    ...
    */
    ...
    public Result<?> set(@Valid @RequestBody WccUserMessage wccUserMessage) {
		return Result.condition(wccUserMessageService.saveOrUpdate(wccUserMessage));
	}
    ...
    */
    ...
    public Result<?> del(@RequestParam String ids) {
		return Result.condition(wccUserMessageService.removeByIds(CollectionUtil.stringToCollection(ids)));
	}
}
