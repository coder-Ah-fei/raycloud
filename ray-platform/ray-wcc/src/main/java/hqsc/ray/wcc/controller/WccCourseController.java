...
public class WccCourseController extends BaseController {
    ...
    private final IWccCourseService wccCourseService;
   ...
   // @PreAuth
    ...
    public Result<?> page(Page page, Map search) {
		return Result.data(wccCourseService.listPage(page, search));
    }
    ...
    public Result<?> get(@RequestParam String id) {
		return Result.data(wccCourseService.getById(id));
	}
    ...
    */
    ...
    public Result<?> set(@Valid @RequestBody WccCourse wccCourse) {
		return Result.condition(wccCourseService.saveOrUpdate(wccCourse));
	}
    ...
    */
    ...
    public Result<?> del(@RequestParam String ids) {
		return Result.condition(wccCourseService.removeByIds(CollectionUtil.stringToCollection(ids)));
	}
}
