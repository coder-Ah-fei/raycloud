...
public class WccMerchantBrandDetailController extends BaseController {
    ...
    private final IWccMerchantBrandDetailService wccMerchantBrandDetailService;
    ...
    public Result<?> page(Page page, Map search) {
		return Result.data(wccMerchantBrandDetailService.listPage(page, search));
    }
    ...
    public Result<?> get(@RequestParam String id) {
		return Result.data(wccMerchantBrandDetailService.getById(id));
	}
    ...
    */
    ...
    public Result<?> set(@Valid @RequestBody WccMerchantBrandDetail wccMerchantBrandDetail) {
		return Result.condition(wccMerchantBrandDetailService.saveOrUpdate(wccMerchantBrandDetail));
	}
    ...
    */
    ...
    public Result<?> del(@RequestParam String ids) {
		return Result.condition(wccMerchantBrandDetailService.removeByIds(CollectionUtil.stringToCollection(ids)));
	}
}
